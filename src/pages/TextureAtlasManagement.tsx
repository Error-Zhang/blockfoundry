...
import { Card, Button, Upload, Table, Space, Modal, Form, Input, InputNumber, message, Popconfirm, Image, Tag, Tooltip, Progress } from 'antd';
import { UploadOutlined, PlusOutlined, EditOutlined, DeleteOutlined, EyeOutlined, DownloadOutlined, ScissorOutlined } from '@ant-design/icons';
...
const TextureAtlasManagement: React.FC = () => {
...
export default TextureAtlasManagement;
